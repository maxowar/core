...
<body>
  ...
  <h1>[<?php echo Core\Util\Config::get('MAIN/application') ?>] 500 | Internal Server Error | <?php echo $name ?></h1>
  ...
  <h2>config <a href="#" onclick="toggle('config'); return false;">...</a></h2>
  <div id="config" style="display: none"><?php echo $configTable ?></div>

  <h2>constants <a href="#" onclick="toggle('constants'); return false;">...</a></h2>
  <div id="constants" style="display: none"><?php echo $constantsTable ?></div>
  
  <h2>session <a href="#" onclick="toggle('user'); return false;">...</a></h2>
  <div id="user" style="display: none"><?php echo $userTable ?></div>

  <h2>routing <a href="#" onclick="toggle('routing'); return false;">...</a></h2>
  <div id="routing" style="display: none"><?php echo $routingTable ?></div>
  
  <h2>database <a href="#" onclick="toggle('database '); return false;">...</a></h2>
  <div id="database " style="display: none"><?php echo $databaseTable ?></div>

  <h2>log <a href="#" onclick="toggle('log'); return false;">...</a></h2>
  <div id="log" style="display: none"><?php echo $logTable ?></div>

  <h2>system <a href="#" onclick="toggle('info'); return false;">...</a></h2>
  <div id="info" style="display: none"><?php echo $infoTable ?></div>

  <p id="footer">
    <?php echo Core\Util\Config::get('MAIN/application') ?>
  </p>
  </div>
  </center>
</body>
